...
export const HeroSection = () => {
  ...
  return (
    <Container>
      <Lines>
        <div className="h-full md:h-screen flex flex-col  gap-28 pt-10 ">
          <div className="flex justify-between  gap-3 w-full">
            <h3 className="text-5xl md:text-6xl lg:text-9xl text-foreground/40">about</h3>
            ...
            <div
                className="h-[1px] w-20 top-1/2 -right-1/2 absolute bg-foreground/40 line transform transition duration-500 ease-in-out group-hover:rotate-180"
              />
            </div>
          </div>
